...
- **Focal Loss** — Focuses on hard, misclassified examples
  ...
  - Focal Loss reduces the impact of easy examples and focuses more on hard, misclassified cases.
...
- Loss steadily decreases from ~0.110 → ~0.094  
- Smooth curve indicates stable training (no divergence)  
- Major learning happens in early epochs (1–7)  
- Curve plateaus after ~epoch 10 → diminishing improvements  
- No signs of overfitting from training loss alone  

...
- ROC curves show strong performance across all tasks.
- Abnormal (AUC = 0.833) performs best.
- ACL (AUC = 0.827) is close second.
- Meniscus (AUC = 0.746) is comparatively weaker.
:::
